              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    CustomizedText(text: "Profile", fontSize: 18, fontWeight: FontWeight.bold, color: white),
                    GestureDetector(
                      onTap: () {},
                      child: Container(
                        width: 40,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    for (int day = DateTime.now().day - 2; day <= DateTime.now().day + 2; day++)
                      Container(
                        padding: const EdgeInsets.all(8.0),
                ...
                const SizedBox(height: 20),
                CustomizedText(text: "A doctor is a medical professional who is trained to diagnose, treat and prevent illnesses and injuries. They use their knowledge and expertise to help patients maintain good health and wellbeing. Doctors work in a variety of settings, including hospitals, clinics, and private practices.", fontSize: 14, color: white),
              ],
            ),
          ),
        ],
