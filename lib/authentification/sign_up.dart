          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                CustomTextField(controller: _usernameController, hint: "Medical Professional Name", to: language),
                const SizedBox(height: 10),
                CustomTextField(controller: _serviceController, hint: "Service", to: language),
                const SizedBox(height: 10),
                CustomTextField(controller: _jobLocationController, hint: "Job Location", to: language),
                const SizedBox(height: 10),
                CustomTextField(controller: _cinController, hint: "National Identity Card", to: language),
                const SizedBox(height: 10),
                CustomTextField(controller: _idController, hint: "Identifier", to: language),
                const SizedBox(height: 10),
                CustomTextField(controller: _emailController, hint: "E-mail", to: language),
                const SizedBox(height: 10),
                CustomTextField(controller: _passwordController, hint: "Password", to: language),
