...
import 'package:smart_care/viewmodels/sign_up_viewmodel.dart';
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[CustomizedText(text: _viewModel.username, color: blue, fontWeight: FontWeight.bold), CustomizedText(text: 'form'.tr, fontWeight: FontWeight.bold)]),
                      const Spacer(),
                      GestureDetector(
                        onTap: () async {
