...
import 'package:smart_care/viewmodels/contact_doctor_viewmodel.dart';
import 'package:url_launcher/url_launcher_string.dart';

import '../stuff/functions.dart';

class ChatView extends StatefulWidget {
  const ChatView({super.key, required this.talkTo});
...
class _ChatViewState extends State<ChatView> {
  final ChatViewModel _viewModel = Get.put(ChatViewModel());
              ...
              return StatefulBuilder(
                  ...
                  builder: (BuildContext context, void Function(void Function()) _) {
                    return Chat(
                      ...
                      showUserNames: true,
                      onAvatarTap: (types.User user) => _viewModel.messages.toString().isEmpty ? null : showDialog(context: context, builder: (BuildContext context) => AlertDialog(content: CachedNetworkImage(imageUrl: user.metadata!["image_url"]))),
                      user: _user,
