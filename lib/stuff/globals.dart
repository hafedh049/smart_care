...
//API-Keys
const String gpt3ApiKey = "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";
const String gpt3ApiUrl = 'https://api.openai.com/v1/engines/text-davinci-003/completions'; //https://api.openai.com/v1/completions
