      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            CustomizedText(text: 'summary'.tr, fontSize: 30, fontWeight: FontWeight.bold, color: white),
            const SizedBox(height: 40),
            CustomizedText(text: 'bookingInfo'.tr, fontSize: 18, fontWeight: FontWeight.bold, color: white),
            const SizedBox(height: 20),
            Padding(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      CustomizedText(text: 'dateTime'.tr, fontSize: 16, fontWeight: FontWeight.bold, color: white),
            ...
            const SizedBox(height: 20),
            Padding(padding: const EdgeInsets.symmetric(horizontal: 8.0), child: Container(color: white.withOpacity(.2), height: .8, width: MediaQuery.of(context).size.width)),
            const SizedBox(height: 20),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 8.0),
              child: Row(
                children: <Widget>[
                  ...
                  Column(
                    ...
                    mainAxisSize: MainAxisSize.min,
                    children: <Widget>[
                      CustomizedText(text: 'appointmentType'.tr, fontSize: 16, fontWeight: FontWeight.bold, color: white),
                      const SizedBox(height: 5),
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Column(
                    ...
                    mainAxisSize: MainAxisSize.min,
                    children: <Widget>[
                      CustomizedText(text: 'duration'.tr, fontSize: 16, fontWeight: FontWeight.bold, color: white),
                      const SizedBox(height: 5),
            ...
            Padding(padding: const EdgeInsets.symmetric(horizontal: 8.0), child: Container(color: white.withOpacity(.2), height: .8, width: MediaQuery.of(context).size.width)),
            const SizedBox(height: 40),
            CustomizedText(text: 'doctorInfo'.tr, fontSize: 18, fontWeight: FontWeight.bold, color: white),
            const SizedBox(height: 20),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 8.0),
              child: Row(
