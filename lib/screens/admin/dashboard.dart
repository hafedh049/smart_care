                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Expanded(child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[CustomizedText(text: card["name"], color: darkBlue, fontSize: 22, fontWeight: FontWeight.bold), const SizedBox(height: 10), Icon(card["icon"], size: 25, color: darkBlue)]))),
                              Container(height: 100, width: 5, decoration: BoxDecoration(borderRadius: BorderRadius.circular(15), color: darkBlue)),
                            ],
                          ),
                        ),
