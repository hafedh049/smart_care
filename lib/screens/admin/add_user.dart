              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const <Widget>[CustomizedText(text: "ADD", color: blue, fontWeight: FontWeight.bold), CustomizedText(text: "USER", fontWeight: FontWeight.bold)],
                    ),
                  ),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      StatefulBuilder(
                        ...
                        builder: (BuildContext context, void Function(void Function()) _) {
                          return CustomizedText(text: _text, color: _color, fontSize: 14, fontWeight: FontWeight.bold);
                        },
                      ),
                    ],
                  ),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: const <Widget>[
                                  Spacer(),
                                  CustomizedText(text: "ADD", color: black, fontWeight: FontWeight.bold, fontSize: 20),
                                  Spacer(),
