                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        ...
                                        content: Row(
                                          ...
                                          children: <Widget>[
                                            IconButton(icon: const Icon(Icons.delete, color: Colors.red), onPressed: () => Navigator.pop(context, 'remove')),
                                            IconButton(icon: const Icon(Icons.edit, color: Colors.amber), onPressed: () => Navigator.pop(context, 'modify')),
                                          ],
                                        ),
                                      );
                                    },
